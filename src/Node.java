...
public class Node<T extends Comparable<T>>{
    ...
    private ArrayList<Node <T>> children = new ArrayList<>(ORDER);//Хранятся ссылки на потомков узла
    private ArrayList<DataItem<T>> items = new ArrayList<>(ORDER - 1); //Ссылки на объекты элементов данных, хранящиеся в узле
    public Node() {
